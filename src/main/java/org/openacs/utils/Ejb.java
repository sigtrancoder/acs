...
public class Ejb {
    ...
    static DaoService daoService = null;

    public static void setDaoService(DaoService srv) {
    	if(null == daoService) {
    		daoService = srv;
    	}
    }
	...
	public static ScriptLocal lookupScriptBean(String string) {
		return daoService.getScriptRepository().findByName(string);
	}

	public static HostPropertyLocalRepository lookupHostPropertyBean() {
		return daoService.getHostPropertyLocalRepository();
	}

	public static ProfilePropertyLocalRepository lookupProfilePropertyBean() {
		return daoService.getProfilePropertyLocalRepository();
	}

	public static ServicePropertyLocalRepository lookupServicePropertyBean() {
		return daoService.getServicePropertyLocalRepository();
	}
