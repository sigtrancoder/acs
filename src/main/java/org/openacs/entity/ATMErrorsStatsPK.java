...
public class ATMErrorsStatsPK implements Serializable {
    ...
    public ATMErrorsStatsPK(Long hostid, Timestamp time, int type) {
        this.hostid = hostid;
        this.time = time;
		this.type = type;
    }
    ...
    public boolean equals(java.lang.Object otherOb) {
        ...
        if (!(otherOb instanceof org.openacs.entity.ATMErrorsStatsPK)) {
            return false;
        }
        org.openacs.entity.ATMErrorsStatsPK other = (org.openacs.entity.ATMErrorsStatsPK) otherOb;
